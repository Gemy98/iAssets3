<%@ page import="com.iassets.common.entity.*,com.iassets.common.util.*"
...
<div id="session_info">
	...
	<ul id="top_menu">
		...
		<li><a
			href="<%=appDir%>/WelcomePageDisplay?purpose=<fmt:message key='jsp.Header.WelcomePageDisplay' />">
				<i class="fa fa-home"></i>
			<fmt:message key='jsp.Header.WelcomePageDisplay.purpose' />
		</a></li>
		<li><a
			href="<%=appDir%>/ChangePasswordDisplay?purpose=<fmt:message key='jsp.Header.ChangePasswordDisplay' />">
				<i class="fa fa-key"></i>
			<fmt:message key='jsp.Header.ChangePasswordDisplay.purpose' />
		</a></li>
		<%}%>
		<%if(WebUtil.currentUserHasPrivilegeForAssigningDirectorateSupervisors(request)){%>
		<li><a
			href="<%=appDir%>/AssignDirectorateSupervisorToSitesDisplay?purpose= <fmt:message key='jsp.Header.AssignDirectorateSupervisorToSitesDisplay.purpose' /> ">
				<i class="fa fa-user"></i>
			<fmt:message
					key='jsp.Header.AssignDirectorateSupervisorToSitesDisplay' />
		</a></li>
		<%}%>
		<%if(WebUtil.userHasRightToChangeSessionHospital(request)){%>
		<li><a
			href="ChooseSessionHospitalDisplay?purpose=<fmt:message key='jsp.Header.ChooseSessionHospitalDisplay.purpose' />">
				<i class="fa fa-hospital-o"></i>
			<fmt:message key='jsp.Header.ChooseSessionHospitalDisplay' />
		</a></li>
		<%} 
		  }%>
...
<div id="header">
	...
	<div id="left_banner_sec">
		<img alt="iAssets" id="iassets_logo" src="image/iassets_logo.png"
			title="iAssets V-4.0.1" width="170" height="40" />
		<!-- onclick="viewFile('\\sys\\iAssets-profile.pdf')" -->
	</div>
	<div id="logo">
		<img src="image/logo_${sessionScope.language}.png" width="960"
			height="116" /> <span id="directorate_name"><%=directorateName%>
			<%-- <%=Default.DIRECTORATE_NAME%> --%></span> <span id="current_hosp_name"><%=currentHospitalName%></span>
