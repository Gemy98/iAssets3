...
<title><%=Default.APP_NAME%> :: <fmt:message
		key="jsp.login.pagetitle" /></title>
<base
...
<link type="text/css" rel="stylesheet"
	href="css/style_${language == 'ar' ? 'rtl' : 'ltr'}.css" />
...
<script type="text/javascript"
	src="js/validation/messages_${language}.js"></script>
	...
	<div id="container">
		...
		<div id="content">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td valign="top" id="content_container"><form
                ...
                %>
                  ...
                  %> <input type="radio"
											value="<%=l.getLanguageCode()%>" name="lang"> <%=l.getDisplayName()%>
											&nbsp;&nbsp; <%
                  	}
                  %>
										</td>
                ...
                %>
									<tr>
										<td class="side_label_top"><fmt:message
												key="jsp.login.username" /> :</td>
										<td><input id="userName" name="userName" type="text"></td>
									</tr>
									<tr>
										<td class="side_label_top"><fmt:message
												key="jsp.login.password" /> :</td>
										<td><input id="password" name="password" type="password"></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
										<td><input type="submit" name="button" id="button"
											value="<fmt:message key="jsp.login.submit" />"
