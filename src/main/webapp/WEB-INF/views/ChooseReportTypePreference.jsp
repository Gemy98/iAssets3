<%@ page pageEncoding="UTF-8"
	import="com.iassets.common.entity.*, java.util.*, com.iassets.common.util.*,org.springframework.beans.factory.annotation.*,org.springframework.web.context.support.SpringBeanAutowiringSupport"%>
...
<table class="layout_grid">
	<tr>
		<td class="side_label_top"><fmt:message
				key="jsp.ChooseReportTypePreference.reportType" />:</td>
		<td valign="top">
			<table id="report_type_options_layout">
				<tr>
					<td colspan="3"><input name="reportType" type="radio"
						value="<%=Enums.REQUESTED_REPORT_TYPE.FOR_ALL_SITE_LOCATIONS.getId()%>">
	  ...
	  %>
				<tr>
					<td colspan="3"><input name="reportType" type="radio"
						value="<%=Enums.REQUESTED_REPORT_TYPE.FOR_CURRENT_LOCATION_ONLY.getId()%>">
						<fmt:message key="jsp.ChooseReportTypePreference.hospitalOrCenter" />
					</td>
				</tr>
				<%
	  	}
	  %>
				<tr>
					<td><input name="reportType" type="radio"
						value="<%=Enums.REQUESTED_REPORT_TYPE.FOR_ANOTHER_LOCATION.getId()%>">

						<% if (currentLocation != null){ %> &nbsp; <fmt:message
							key="jsp.ChooseReportTypePreference.reportType1" /> <%}else{ %>
						&nbsp; <fmt:message
							key="jsp.ChooseReportTypePreference.reportType2" /> <%}%></td>
					<td>&nbsp;&nbsp;&nbsp;</td>
					<td><select class="auto_off" name="reportLocation"
						id="reportLocation" onChange="setLocationCookie()">
							<%
