<%@ page contentType="text/html;charset=UTF-8"
	import="com.iassets.common.util.*,com.iassets.common.entity.*"%>
...
if (currentUser != null) {
%>
<label class="breadcrumbs" id="current_user_name"> <fmt:message
		key="jsp.SessionInfo.hello" /> &nbsp;<%=currentUser.getName(siLangCode)%></label>
<%}if (purpose != null) {
%>
<label class="breadcrumbs" id="current_function_name"> ... <fmt:message
		key="jsp.SessionInfo.required" /> :&nbsp;<%=purpose%><%-- <%=new String(purpose.getBytes(), "utf-8")%> --%>
