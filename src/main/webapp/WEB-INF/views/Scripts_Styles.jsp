...
<link type="text/css" rel="stylesheet"
	href="js/ajaxloader/ajaxloader.css" />
<!--<link type="text/css" rel="stylesheet" href="css/style.css"/>-->


<link type="text/css" rel="stylesheet"
	href="css/style_${sessionScope.language == 'ar' ? 'rtl' : 'ltr'}.css" />
<link type="text/css" rel="stylesheet"
	href="css/slidedown-menu_${sessionScope.language == 'ar' ? 'rtl' : 'ltr'}.css" />
...
<script type="text/javascript"
	src="js/validation/messages_${sessionScope.language}.js"></script>
...
<script type="text/javascript"
	src="js/jquery.tablesorter/jquery.tablesorter.widgets.js"></script>
