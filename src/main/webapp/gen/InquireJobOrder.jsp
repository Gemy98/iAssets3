...
%>
<body>
<form method="post" action='gen/<%=WebUtil.getSearchProcessURL(request)%>' <%=target%> onSubmit="return _onSubmitJobOrderInquiryForm();">
  <table class="layout_grid">
    <tr>
      <td colspan="2"><h1 class="page_title">شاشة الاستعلام عن أمر عمل</h1></td>
    </tr>
    <tr>
