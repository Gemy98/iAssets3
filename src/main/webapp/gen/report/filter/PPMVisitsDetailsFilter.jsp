...
<%@ page contentType="text/html;charset=UTF-8"	import="com.iassets.common.util.*,com.iassets.general.util.HtmlUtil,com.iassets.common.entity.*,java.util.List"%>
...
<body>
	<form method="post" action="gen/ViewPPMVisitsDetails" target="_blank">
...
--%>
			...
			<tr>
				<td>&nbsp;</td><td><input type="submit"	value="عرض"></td>
			</tr>
		</table>
	</form>
</body>
