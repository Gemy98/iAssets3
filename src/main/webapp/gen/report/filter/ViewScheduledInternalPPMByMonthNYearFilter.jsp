...
<%@ page contentType="text/html;charset=UTF-8"
	import="com.iassets.common.util.*,com.iassets.general.util.HtmlUtil,com.iassets.common.entity.*,java.util.*"%>
...
<body>
	<form method="post" action='gen/ViewScheduledInternalPPMByMonthNYear' target="_blank">
		<table class="layout_grid">
			...
			<tr>
				<td class="side_label_middle">المبني</td>
				<td><select name="location" id="location" class="auto_add_all auto_off">
						<%
						List<CommonHospitalLocation> hospLocationList = (List<CommonHospitalLocation>) request.getAttribute("siteLocationList");
							if (hospLocationList != null) {
								for ( CommonHospitalLocation  location : hospLocationList){
						%>
