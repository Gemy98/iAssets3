<!DOCTYPE html>
<%@ page contentType="text/html;charset=UTF-8"  import="com.iassets.common.entity.*,com.iassets.common.util.*,java.util.*"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
<fmt:setBundle basename="i18n.jsp_literals" /><html dir="${sessionScope.direction}">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
<style type="text/css">
  a#report_link{display: inline-block; padding: 12px; border: 1px solid #000; text-decoration: none; background-color: #000 ;color: #fff; margin: auto auto 20px auto;font-size: 20px; font-weight: bold}
</style>
<%
...
<form method="post" action="ChooseSessionHospitalProcess">
  <table class="layout_grid basic_page">
    <tbody>
       ...
       %>
      <tr>
        <td colspan="2" align="center"><a id="report_link" target="_blank" rel='opener' href="bio/ViewDirectoratePerformanceReport"><fmt:message key="jsp.view.bio.directorate.monthly.performance.report" /></a></td>
      </tr>
      <%}%>
      <tr>
        <td colspan="2"><h1 class="page_title"><fmt:message key="jsp.ChooseHospital.pagetitle" /></h1></td>
      </tr>
      <% String cssClass = (userAssignedToManySites) ? "" : "class='auto_off'";%>
      <tr <%=(!userAssignedToManySites)?"style='display:none'" : ""%>>
        <td class="side_label_middle"> <fmt:message key="jsp.ChooseHospital.siteName" />: </td>
        <td><select style="min-width: 160px" name="site" <%=cssClass%> onChange="getHospitalList(this)" required>
            <%if (siteList != null)
      ...
      <tr>
        <td class="side_label_middle"><fmt:message key="jsp.ChooseHospital.hospitalOrCenter" />  :</td>
        <td id="hospListContainer"> 
          <select style="min-width: 160px" id='hospital' name='hospital' class='auto_off' required>
    ...
    <tr>
      <td id="submitBtnsContainer" style="padding-top:20px" colspan="2" align="left">
