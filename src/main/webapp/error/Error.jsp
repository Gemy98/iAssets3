<!DOCTYPE html>
<%@ page contentType="text/html;charset=UTF-8" isErrorPage="true" import="org.apache.commons.lang.StringEscapeUtils,com.iassets.common.util.*"%>
...
<h1 class='error_msg'><fmt:message key="jsp.Error.msg1" /></h1>

<%}else{ %>

<h1 class='error_msg'><fmt:message key="jsp.Error.msg2" /></h1>
<h1 class='error_msg'><fmt:message key="jsp.Error.msg3" /></h1>
