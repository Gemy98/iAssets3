...
<c:set var="direction" value='${language == "en" ? "ltr" :"rtl"}' scope="session" />
<% 
...
<link type="text/css" rel="stylesheet" href="${language == 'en' ? 'css/style_ltr.css':'css/style_rtl.css'}"/>
...
<div id="container">
  ...
  <div style="font-size: 20px;font-weight: bold;color:#f00;text-align: center;line-height: 50px;padding-top: 70px" id="content"><fmt:message key="jsp.Suspended.msg" /><!-- <br />
