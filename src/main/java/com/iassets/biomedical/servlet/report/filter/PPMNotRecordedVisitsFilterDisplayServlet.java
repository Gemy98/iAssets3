...
@WebServlet(value={"/bio/PPMNotRecordedVisitsFilterDisplay"})
public class PPMNotRecordedVisitsFilterDisplayServlet
extends BioBasicServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        this.forward(request, response, "/bio/report/filter/PPMNotRecordedVisitsFilter.jsp");
    }
}
