...
@WebServlet(value={"/bio/DirectorateDashboardViewer"})
public class DirectorateDashboardViewerServlet
extends CommonBasicServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        this.viewHTMLReport(request, response, "/bio/dashboard/GaugePOC.jsp", "");
    }
