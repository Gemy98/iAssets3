...
@WebServlet(value={"/bio/UserProfileDisplay", "/gen/UserProfileDisplay"})
public class UserProfileDisplayServlet
extends CommonBasicServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        this.forward(request, response, "/systemsettings/UserProfile.jsp");
    }
}
