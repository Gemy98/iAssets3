...
public final class DynamicQueryBuilder {
    ...
    private Query query;
    private Operator.OperType operType = null;
    ...
    public String getQueryString() {
        return this.queryString.toString().trim();
    }
    ...
    public static class Builder<T> {
        ...
        public Builder(EntityManager em) {
            this.em = em;
            this.dqb = new DynamicQueryBuilder();
        }
        ...
        public Builder withOperType(Operator.OperType operType) {
        ...
        public Builder withAdvancedParam(String param, Operator operator, Object extras) throws IllegalArgumentException {
        ...
        private void resolveAdvancedParams() {
            ...
            for (String key : this.dqb.advancedParams.keySet()) {
                ...
                Operator oper = (Operator)((Object)((Map)this.dqb.advancedParams.get(key)).keySet().iterator().next());
        ...
        private void handleAdvancedParamsOpers(String key, Operator operator, Object extras) {
            ...
            if (operator.equals((Object)Operator.IN)) {
                this.dqb.paramsAndValues.put(key, extras);
            } else if (operator.equals((Object)Operator.LIKE)) {
                this.dqb.paramsAndValues.put(key, Operator.adjustLikeValue((String)this.dqb.paramsAndValues.get(key), (Operator.LikePattern)((Object)Operator.LikePattern.class.cast(extras))));
            } else if (operator.equals((Object)Operator.BETWEEN)) {
        ...
        private void isValidAdvancedParam(Operator operator, Object value) throws IllegalArgumentException {
            switch (operator) {
                case LIKE: {
                    if (value instanceof Operator.LikePattern) break;
