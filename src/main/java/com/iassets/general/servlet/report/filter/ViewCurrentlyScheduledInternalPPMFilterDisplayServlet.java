...
@WebServlet(value={"/gen/ViewCurrentlyScheduledInternalPPMFilterDisplay"})
public class ViewCurrentlyScheduledInternalPPMFilterDisplayServlet
extends GenBasicServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        this.forward(request, response, "/gen/report/filter/ViewCurrentlyScheduledInternalPPMFilter.jsp");
    }
}
