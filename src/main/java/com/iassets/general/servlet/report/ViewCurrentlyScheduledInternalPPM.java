...
@WebServlet(value={"/gen/ViewCurrentlyScheduledInternalPPM"})
public class ViewCurrentlyScheduledInternalPPM
extends GenBasicServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = 1;
        String jpql = "SELECT h FROM GenHospitalDeviceInternalPpmNotificationSchedule h WHERE h.recorded IS NULL AND (CURRENT_TIMESTAMP BETWEEN h.plannedDate AND h.notificationValidTo) AND h.siteId = " + siteId;
        if (buildingId != 0) {
        ...
        if ((nsList = this.genDBQueryManager.executeRetriveJPQLWithPositionalParameters(jpql = jpql + " ORDER BY h.plannedDate", map, GenHospitalDeviceInternalPpmNotificationSchedule.class, "GenHospitalDeviceInternalPpmNotificationSchedule.graph.fetchAll")) == null || nsList.isEmpty()) {
            this.announceErorrMessage(request, response, "\u0644\u0627 \u062a\u0648\u062c\u062f \u0635\u064a\u0627\u0646\u0629 \u0648\u0642\u0627\u0626\u064a\u0629 \u0645\u062c\u062f\u0648\u0644\u0629 \u0644\u0645 \u064a\u062a\u0645 \u062a\u0633\u062c\u064a\u0644\u0647\u0627 \u0628\u0627\u0644\u0646\u0638\u0627\u0645");
            return;
        }
        request.setAttribute("nsList", nsList);
        this.viewHTMLReport(request, response, "/gen/report/ViewInternalPPMSchedules.jsp", "\u0628\u064a\u0627\u0646 \u0628\u0627\u0644\u0635\u064a\u0627\u0646\u0629 \u0627\u0644\u0648\u0642\u0627\u0626\u064a\u0629 \u0627\u0644\u0645\u062c\u062f\u0648\u0644\u0629");
    }
}
